    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='provider', to='insitu.CopernicusService')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='provider', to='picklists.Country')),
        ...
        migrations.AddField(
            model_name='data',
            name='providers',
            field=models.ManyToManyField(through='insitu.DataProviderRelation', to='insitu.DataProvider'),
        ),
        migrations.AddField(
            model_name='dataprovideruser',
            name='provider',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='provider', to='insitu.DataProvider'),
