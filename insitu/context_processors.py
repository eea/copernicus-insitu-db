...
def base(request):
    return {
        ...
        "DATA_DATA_PROVIDER_EDITOR_GROUP": settings.DATA_DATA_PROVIDER_EDITOR_GROUP,
        "PICKLISTS_EDITOR_GROUP": settings.PICKLISTS_EDITOR_GROUP,
        "SHOW_MIGRATION_BANNER": settings.SHOW_MIGRATION_BANNER,
    }
...
def crazy_egg(request):
    ...
    if not settings.DEBUG and crazy_egg_path:
        return {"CRAZY_EGG": crazy_egg_path}
    return {}
