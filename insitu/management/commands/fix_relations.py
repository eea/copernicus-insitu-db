...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        faulty_requirements = [
            ...
            or requirement.uncertainty.state != requirement.state
            or requirement.update_frequency.state != requirement.state
            or requirement.timeliness.state != requirement.state
            or requirement.horizontal_resolution.state != requirement.state
            or requirement.vertical_resolution.state != requirement.state
        ]
