...
PICKLISTS_DESCRIPTION = {
    ...
    'Policy': 'The policy dictated terms associated with access to required data and any associated costs.',
    ...
    'ProductStatus': 'This attribute is used to classify a given product according to its matureness or operational status.',
