...
from insitu.views._reports.base import BaseExcelMixin, BasePDFMixin


class StandardReportPDFMixin(BasePDFMixin):
...
class StandardReportExcelMixin(BaseExcelMixin):
