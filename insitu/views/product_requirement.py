...
class ProductGroupRequirementAdd(BaseProductRequirementAdd):
    ...
    message = (
        "The relations between the product group's products and requirement "
        "were created succesfully!"
    )
...
class ProductRequirementEdit(LoggingProtectedUpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "The relation between product and requirement was updated successfully!",
        )
        return response
    ...
    def get_form_kwargs(self):
        ...
        kwargs.update(
            {"url": self.kwargs["pk"]}
        )  # or wherever the url parameter is coming from
        return kwargs
    ...
    def get_success_url(self):
        if self.request.method != "GET":
            messages.success(
                self.request,
                (
                    "The relation between product and requirement was deleted "
                    "successfully!"
                ),
            )
        return reverse_lazy(
