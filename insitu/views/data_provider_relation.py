...
class DataDataProviderAdd(CreatedByMixin, LoggingProtectedCreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "The relation between data and data provider was created successfully!",
        )
        return response
    ...
    def get_success_url(self):
        return reverse_lazy("data:detail", kwargs={"pk": self.kwargs["group_pk"]})
...
class DataDataProviderEdit(LoggingProtectedUpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "The relation between data and data provider was updated successfully!",
        )
        return response
...
class DataDataProviderDelete(LoggingProtectedDeleteView):
    ...
    def get_success_url(self):
        if self.request.method != "GET":
            messages.success(
                self.request,
                "The relation between data and data provider was deleted successfully!",
            )
        return reverse_lazy("data:detail", kwargs={"pk": self.kwargs["group_pk"]})
