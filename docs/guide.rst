...
Report detail page
-----------------
On the report detail page has the name and description on the top part. After those there are two tabs,
"Preview" and "Pivot".
The preview tab contains the data as it was generated by the query executed against the database. This
is available for download by clicking the button below the "Preview" tab named "Download Excel". (*Figure 15*)

..  figure:: screenshots/report_detail.png
    :width: 600px
    :align: center
    :target: _images/report_detail.png

    *Figure 15. Report detail page*
-----
Pivot
-----
By clicking the "Pivot" tab a new table will appear. On the top of this table or sometimes
...
..  figure:: screenshots/barrier.png
    ...
    *Figure 20. An example table from help page*

For Example, in *Figure 20* is one of the tables available on the Help page. Under the table title there is a small
