...
This is the state that the object has on its creation. In this state the object is editable. The owner
or one of their teammates can mark as ready the object.

**Ready for validation**

In this state the object cannot be edited. A user different from the owner or their teammates can 
...
In this state the object cannot be edited. The owner or one of their teammates can get the object back
to the draft state.
...
In this state, the workflow has ended and the object cannot be modified anymore.
The object can be sent back to "Draft" state if the users agree that more changes should be made to it.

-----------------------------------------------
State of the relation objects during validation
-----------------------------------------------
The relations between the objects do not go through the validation workflow. As such, relations between entries can
be created, edited or deleted no matter the state of the objects they are linking.
